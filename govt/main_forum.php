...
<div align = "center">
	...
	<h4> In this section, Information Related to various Government Offices/Banks/Institutions and their workings related to paper matters are shared to edudcate the young 
	generation against such things and to stop corruption
	happening at these offices, so that any visitor to such offices are not victim of such practises. The Topics Discussed So Far are Below. You can create your own Topic for an Issue or spread Knowledge 
	about any type of Government Office and its working. </h4>
	</br>
	<?php }?>
