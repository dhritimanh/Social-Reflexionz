...
<body>
	...
	<form name = form1 action="add_topic.php" method="post">
		...
		<fieldset>
			<legend>New Election Setup</legend>
				...
				<label for="input-two" class="float"><strong>Your Name:</strong></label><br />
				<input class="inp-text" name="name"  id="input-two" type="text" size="30" />
				
				<label for="input-two" class="float"><strong>Your Email:</strong></label><br />
		...
		<p><input class="submit-button" type="image" src="pic/send-button.gif" alt="SUBMIT" name="Submit" value="SUBMIT" />
